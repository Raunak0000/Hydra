	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(jobs) == 0 {
			...
			for _, job := range jobs {
				...
				var templ_7745c5c3_Var38 = []any{"text-rose-500 font-bold uppercase tracking-wider text-[9px] flex items-center gap-1.5 status-badge", templ.KV("hidden", job.Status == "DOWNLOADING" || job.Status == "QUEUED" || job.Status == "SCHEDULED" || job.Status == "PAUSED" || job.Status == "COMPLETED" || job.Status == "PENDING_PATH")}
				templ_7745c5c3_Err = templ.RenderCSSItems(ctx, templ_7745c5c3_Buffer, templ_7745c5c3_Var38...)
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 43, "<span data-badge-status=\"ERROR\" class=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
